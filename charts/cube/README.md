...
| `config.sqlSuperUser`                                      | The superuser name to access the SQL api                                                                                     |         |
...
| `datasources.<name>.passFromSecret.name`                   | The host URL for a database (using secret)                                                                                                                                                                                                                                    |         |
| `datasources.<name>.passFromSecret.key`                    | The host URL for a database (using secret)                                                                                                                                                                                                                                    |         |
...
| `datasources.<name>.passFromSecret.name`                   | The username used to connect to the database (using secret)                                                                                                                                                                                                                   |         |
| `datasources.<name>.passFromSecret.key`                    | The username used to connect to the database (using secret)                                                                                                                                                                                                                   |         |
